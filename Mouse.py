...
while True:
    ...
    if len(lmList) != 0:
        ...
        cv2.rectangle(img, (frameR, frameR), (wCam - frameR, hCam - frameR), (128, 255, 0), 2)

        # 4. Only Index Finger : Moving Mode
        if fingers[1] == 1 and fingers[2] == 0:
            # 5. Convert Coordinates as our cv window is 640*480 but my screen is HD so have to convert it accordingly
            ...
            cv2.circle(img, (x1, y1), 15, (255, 0, 0), cv2.FILLED)  # circle shows that we are in moving mode
